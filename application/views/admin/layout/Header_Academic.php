...
<div class="mx-3">บริหารงานวิชาการ</div> 
                        <li class="nav-item has-submenu">
                            ...
                            <!--//nav-link-->
                            <div id="submenu-2"
                                class="collapse submenu submenu-2 <?=$this->uri->segment('3')=="Registration" ? "show" :""?>"
                                data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a
                                            class="submenu-link <?=$this->uri->segment('4')=="Enroll" ? "active" :""?>"
                                    ...
                                    <li class="submenu-item"><a
                                            class="submenu-link <?=$this->uri->segment('4')=="ClassRoom" ? "active" :""?>"
                                            href="<?=base_url('Admin/Acade/Registration/ClassRoom');?>">จัดการห้องเรียน /
                                            ที่ปรึกษา</a>
                                    </li>
                                    <li class="submenu-item"><a
                                            class="submenu-link <?=$this->uri->segment('4')=="Students" ? "active" :""?>"
                        ...
                        <li class="nav-item has-submenu">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link submenu-toggle <?=$this->uri->segment('3')=="Evaluate" ? "active" :""?>"
                            ...
                            <!--//nav-link-->
                            <div id="submenu-1"
                                class="collapse submenu submenu-1 <?=$this->uri->segment('3')=="Evaluate" ? "show" :""?>"
                                data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a
                                    ...
                                    <li class="submenu-item"><a
                                            class="submenu-link <?=$this->uri->segment('4')=="SaveScore" ? "active" :""?>"
                                    ...
                                    <li class="submenu-item"><a
                                            class="submenu-link <?=$this->uri->segment('4')=="ReportRoom" ? "active" :""?>"
