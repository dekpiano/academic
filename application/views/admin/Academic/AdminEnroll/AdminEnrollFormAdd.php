        ...
        <form id="FormEnroll" method="post" class="needs-validation" novalidate>
            ...
            <div class="row g-4 settings-section">
                ...
                <div class="col-12 col-md-4">
                    <h4 class="section-title">วิชาเรียน</h4>
            ...
            <div class="row g-4 settings-section">
                <div class="col-12 col-md-4">
                    <h4 class="section-title">ครูผู้สอน</h4>
            ...
            <div class="row g-4 settings-section">
                <div class="col-12 col-md-4">
                    <h4 class="section-title">นักเรียน</h4>
                    ...
                    <div class="card shadow-sm p-2">
                        <div class="">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-5">
                                    <select name="to[]" id="multiselect_to" class="form-control" size="8" required
                                        multiple="multiple" style="height:20rem"></select>

                                    <div class="row">
                                        <div class="col-lg-6">
                                            <button type="button" id="multiselect_move_up" class="btn btn-block"><i
